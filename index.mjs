/*!
    @e53e04ac/ipp5-backend-api-builder/index.mjs
...
/** @type {import('.').Ipp5BackendApiBuilder.Constructor} */
const constructor = ((options) => {
    ...
    /** @type {import('.').Ipp5BackendApiBuilder._Self} */
    const _self = ({
        options: (() => {
            return options;
        }),
        ...
        runDirectory: hold(() => {
            return _options.tmpDirectory().resolve('ipp5-backend-api-builder', _options.runId());
        }),
        ...
        makeDockerfile: hold(async () => {
            await _self.azureTerraformer().createFileFromTemplate({
                ...
                /** @type {import('.').Ipp5BackendApiBuilder.DockerfileVariableMap} */
                map: {
    ...
    /** @type {import('.').Ipp5BackendApiBuilder.Self} */
    const self = ({
        ...EventEmitter({}),
        _Ipp5BackendApiBuilder: (() => {
            return _self;
        }),
        build: hold(async () => {
            await _self.makeApp();
...
/** @type {import('.').Ipp5BackendApiBuilder.Companion} */
const companion = ({});

/** @type {import('.').Ipp5BackendApiBuilder.ConstructorWithCompanion} */
const constructorWithCompanion = Object.assign(constructor, companion);

export { constructorWithCompanion as Ipp5BackendApiBuilder };
