/*!
    @e53e04ac/ipp5-backend-api-builder/index.d.ts
...
export declare namespace Ipp5BackendApiBuilder {
    ...
    type Self = EventEmitter<EventSpecs> & {
        readonly _Ipp5BackendApiBuilder: Get<_Self>;
...
export declare type Ipp5BackendApiBuilder = Ipp5BackendApiBuilder.Self;

export declare const Ipp5BackendApiBuilder: Ipp5BackendApiBuilder.ConstructorWithCompanion;
